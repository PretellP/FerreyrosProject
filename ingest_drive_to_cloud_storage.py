...
def upload_massive(worksheets, local_folder_name, bucket_name, bucket_folder_name):
...
upload_massive(lgd.worksheets, local_folder_name, bucket_name, bucket_folder_name)
